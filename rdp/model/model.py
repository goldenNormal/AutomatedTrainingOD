...
class RDP_Model:
    ...
    def load_state_dict(self,s_dict):
        self.r_target_net.load_state_dict(s_dict['r_target_net'])
        self.r_net.load_state_dict(s_dict['r_net'])

    def state_dict(self):
        return {'r_target_net':self.r_target_net.state_dict(),
